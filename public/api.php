...
const ROUTES = [
    ...
    'apiGetOverdueSuspensions' => ['payroll.view', 'Suspensions', ''],
    ...
    'apiGetStaleMemoranda' => ['document.view', 'Memorandum', ''],
    ...
    'apiGetExpiringBioExemptions' => ['document.view', 'BioExemptions', ''],
    ...
    'apiGetExpiringContracts' => ['contract.view', 'Contracts', ''],
