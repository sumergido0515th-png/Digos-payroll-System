...
4. **Whether to take the 9A–9E split** or run the phase as one session against the frozen scope.
   **DECIDED 2026-08-29: the split is taken.** 9A is done; the rest run one session each.

Decisions 1–3 are still open. None of them gates 9B; **decision 3 gates 9C** and
**decisions 1 and 2 gate 9D**, so they need answering before those sessions, not before the next one.
