...
- **9E's UI scope stopped short of every entity, on purpose and on record.** *(2026-08-31.)*
  ...
  the CSV export's query. **Still open**: the full "Who/What/When/State/Who acted" facet breadth
  for those four, and **Suspensions still has no standalone list screen at all**.
