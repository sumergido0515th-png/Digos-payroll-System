...
- `contract.view` — apiGetContractFacets, apiGetContractHistory, apiGetExpiringContracts, apiListContracts
...
- `document.view` — apiGetBioExemptionFacets, apiGetExpiringBioExemptions, apiGetMemorandum, apiGetMemorandumFacets, apiGetStaleMemoranda, apiGetTravelOrderFacets, apiListBioExemptions, apiListMemoranda, apiListTravelOrders
...
- `payroll.view` — apiComputePayroll, apiGetOverdueSuspensions, apiGetPayroll, apiGetPayrollFacets, apiGetSuspensionFacets, apiListPayrolls, apiListSuspensions, apiRunPreAudit
