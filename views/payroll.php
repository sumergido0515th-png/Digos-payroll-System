<!-- ==========================================================================
     payroll.php - Payroll Transactions (list + entry grid + workflow) only.
     The Payroll Period register, once bundled in this same file, now lives
     in its own views/periods.php - two independent page modules with no
     cross-references, split the same way app/PrintDoc.php's seven form
     renderers were: EXECUTION_BUDGET.md named this file, at 515 lines, as
     one of the three most tempting-and-wasteful to fully rewrite for a
     small change; it had grown to 664 carrying both screens.
     ========================================================================== -->
